...
from cli.jj import JjError
from cli.plugin import actions as actions_module
from cli.plugin import state
...
class TestPick:
    def test_opens_picker_pane(self, monkeypatch, tmp_path):
        rc, env, calls = run_action(monkeypatch, tmp_path, actions_module.pick)
